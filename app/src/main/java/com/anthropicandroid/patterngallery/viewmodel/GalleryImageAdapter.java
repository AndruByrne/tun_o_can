...
import static com.anthropicandroid.patterngallery.model.utils.Utils
...
public class GalleryImageAdapter {
    ...
    public static void setImageIndex(
        ...
        galleryActivityComponent.getRepository()
                ...
                // scale bitmap
                .map(new Func1<com.anthropicandroid.patterngallery.model.GalleryImage, GalleryImageHolder>() {
                    @Override
                    public GalleryImageHolder call(com.anthropicandroid.patterngallery.model.GalleryImage galleryImage) {
